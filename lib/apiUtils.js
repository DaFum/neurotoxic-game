 ...
 * and DEL that would otherwise corrupt leaderboard display or server logs.
 * Callers must still trim and length-validate the result.
 * @param {string} name - The raw player name. Non-string input yields `''`.
 * @returns {string} The name with control characters removed.
 */
