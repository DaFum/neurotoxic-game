...
// This is critical because the optimized version mutates the array in-place.
// Reusing the same array would mean subsequent runs process fewer/different items.
console.log('Generating test data...')
const testCases = Array.from({ length: RUNS }, () => createProjectiles())
