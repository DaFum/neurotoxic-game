...
console.log(
  `Running benchmark with array size ${ARRAY_SIZE} over ${RUNS} iterations...`
)
...
console.log(
  `Biased Shuffle Average time per run: ${(timeBiased / RUNS).toFixed(4)}ms`
)
...
console.log(
  `Fisher-Yates Shuffle Average time per run: ${(timeFisher / RUNS).toFixed(4)}ms`
)
