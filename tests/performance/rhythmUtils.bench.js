import { calculateTimeFromTicks, preprocessTempoMap } from '../../src/utils/rhythmUtils.js';
...
console.log(`Average time per call (Optimized): ${((end - start) / notes.length).toFixed(6)}ms`);
