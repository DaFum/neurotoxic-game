...
- For minigame end flows with completion overlays, add a fallback-timer test plus an unmount cleanup test so auto-advance timers cannot leak or strand scenes.
