...
test('shouldRebuildAudioContextState handles unrecoverable states', () => {
  assert.strictEqual(shouldRebuildAudioContextState('closed'), true)
  assert.strictEqual(shouldRebuildAudioContextState('unknown'), true)
  assert.strictEqual(shouldRebuildAudioContextState('suspended'), false)
  assert.strictEqual(shouldRebuildAudioContextState('running'), false)
})
