...
describe('purchaseLogicUtils', () => {
  ...
  describe('canAfford', () => {
    ...
    test('rejects Infinity, NaN, and string values by treating them as 0', () => {
      ...
      assert.equal(
        canAfford({ currency: 'money' }, { money: 'Infinity' }, 10),
        false
      )
      assert.equal(
        canAfford(
      ...
      assert.equal(
        canAfford({ currency: 'money' }, { money: Number.NaN }, 10),
        false
      )
      ...
      assert.equal(
        canAfford({ currency: 'money' }, { money: 'Infinity' }, 0),
        true
      )
      assert.equal(
        canAfford(
      ...
      assert.equal(
        canAfford({ currency: 'money' }, { money: Number.NaN }, 0),
        true
      )
