...
export const BALANCE_SOURCE_FILES = Object.freeze([
  ...
  // ── Roguelite Expedition (G1-G5) ────────────────────────────────────────────
  // The v15 report and the runtime pacing gate are both fingerprinted against
  // this list. Without the Expedition owners, an edit to travel cost, a Tour or
  // Region registry, a Contract or the run reducer could move pacing and
  // retained Cash while leaving `sourceFingerprint` identical - and
  // `loadCapturedRuntimeEvidence` would go on accepting playtest samples
  // captured from the old build.
  'src/domain/expedition/archive.ts',
  'src/domain/expedition/authority.ts',
  ...
  'src/domain/expedition/crewEventOutcomes.ts',
  ...
  'src/domain/expedition/eventDeltas.ts',
  'src/domain/expedition/eventProof.ts',
  ...
  'src/domain/expedition/routeOverlay.ts',
  'src/domain/expedition/routeProfile.ts',
  'src/domain/expedition/runDrafts.ts',
  'src/domain/expedition/runResources.ts',
  'src/domain/expedition/social.ts',
  'src/domain/expedition/sponsors.ts',
  'src/domain/expedition/travel.ts',
  'src/data/expedition/archive.ts',
  'src/data/expedition/betweenTour.ts',
  ...
  'src/data/expedition/legendaries.ts',
  ...
  'src/context/reducers/crewReducer.ts',
  'src/context/reducers/minigameReducer.ts',
  'src/context/expeditionActionCreators.ts',
  'src/utils/gigStats.ts',
  'src/utils/economy/minigameLogic.ts',
  'src/utils/economy/logisticsLogic.ts'
])
