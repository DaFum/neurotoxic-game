...
async def verify_leaderboard_final():
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.fill("input[placeholder='ENTER NAME...']", "FinalCheckUser")
            ...
            if player_name != "FinalCheckUser":
                raise Exception(f"Player Name mismatch! Expected 'FinalCheckUser', got '{player_name}'")
            ...
            await page.screenshot(path="verification/leaderboard_final.png")
            print("Success! Screenshot saved to verification/leaderboard_final.png")

        except Exception as e:
            print(f"Error: {e}")
            await page.screenshot(path="verification/leaderboard_error.png")
            raise e
        finally:
            await browser.close()

if __name__ == "__main__":
    asyncio.run(verify_leaderboard_final())
