...
# Fix ReportPhase
content = content.replace("ReportPhase: ({ onNext, ...layoutProps }) => (", "ReportPhase: ({ financials, onNext, ...layoutProps }) => (")
# But it might be `ReportPhase: ({ onNext }) => (` since I wrote the new mock from scratch
