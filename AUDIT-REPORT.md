...
**Follow-up status:** entries marked with `✅ DONE` were addressed in the implementation pass after this audit. Unmarked entries remain open or were not part of that pass.

---

## 1. DUPLICATES

### ✅ DONE — D1 — Quest reward/penalty helper cluster (NEAR-duplicate) · **HIGH** · MERGE
...
### ✅ DONE — D2 — `getQuestToastName` (EXACT duplicate) · **MED** · DELETE copy
...
### ✅ DONE — D3 — Asset validation constants (NEAR-duplicate, drift hazard) · **MED** · MERGE
...
### ✅ DONE — D4 — `VALID_CATEGORIES` event-category set (NEAR-duplicate, latent bug) · **MED** · MERGE
...
### ✅ DONE — D5 — `BASE_MERCH_CAPACITY` + capacity formula (EXACT duplicate) · **MED** · MERGE
...
### ✅ DONE — D6 — `neurotoxic_global_settings` read/parse (NEAR-duplicate magic-string) · **MED** · MERGE
...
### ✅ DONE — D7 — `runSafeStorageOperation` triple facade (redundant wrappers) · **LOW** · MERGE/DELETE
...
### ✅ DONE — D8 — `HEX_COLOR_PATTERN` regex (NEAR-duplicate, divergent) · **LOW** · MERGE
...
### ✅ DONE — D9 — `isRecord` reimplements `isLooseRecord` (RE-IMPLEMENTED util) · **LOW** · MERGE
...
### ✅ DONE — D10 — `finiteNumberOrZero` reimplements `finiteNumberOr(x,0)` (RE-IMPLEMENTED util) · **LOW** · DELETE
...
### ✅ DONE — D11 — Inline forbidden-key check bypasses `isForbiddenKey` (RE-IMPLEMENTED util) · **LOW** · MERGE
...
### ✅ DONE — O1 — `isModuleUnlocked` is the documented owner of module unlock semantics but has no production caller · **HIGH** · INTEGRATE
...
### ✅ DONE — O2 — `CatalogEffect` type alias (dead) · **LOW** · DELETE
...
### ✅ DONE — O3 — `BrandColorName` type (dead) · **LOW** · DELETE
...
### ✅ DONE — I1 — `applyContrabandEffect` harmony branch addend not wrapped · **HIGH** · FIX
...
### ✅ DONE — I2 — `applyEventDelta` money/fame/harmony/van/luck addends unwrapped · **HIGH** · FIX
...
### ✅ DONE — I3 — `calculateAppliedDelta` bare `typeof === 'number'` admits NaN · **MED** · FIX
...
### ✅ DONE — I4 — `EFFECT_REVERTERS.harmony` revert addend unguarded · **MED** · FIX
...
### ✅ DONE — DEAD1 — `SELL_CHASSIS_FAILED` action type never produced · **LOW** · FIX
...
### ✅ DONE — M1 — `CONSUME_ITEM` chain fully built, never triggered · **MED** · INTEGRATE
...
### ✅ DONE — M2 — `ADD_VENUE_BLACKLIST` action path redundant/dead · **LOW** · DELETE
...
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| MED      | `src/domain/questRewards.ts:86`, `src/domain/questPenalties.ts:104`                                                                                                                                     | ✅ DONE — Exact duplicate `getVenueReputationKey` logic exists in reward and penalty paths.                                                                                             | MERGE              |
| MED      | `src/domain/questRewards.ts:99`, `src/domain/questPenalties.ts:117`                                                                                                                                     | ✅ DONE — Exact duplicate `getRegionReputationKey` logic exists in reward and penalty paths.                                                                                            | MERGE              |
| MED      | `src/domain/questRewards.ts:110`, `src/domain/questPenalties.ts:128`                                                                                                                                    | ✅ DONE — Exact duplicate `applyReputationDelta` logic exists in reward and penalty paths.                                                                                              | MERGE              |
| MED      | `src/domain/questRewards.ts:126`, `src/domain/questPenalties.ts:144`                                                                                                                                    | ✅ DONE — Exact duplicate `applyVenueReputationDelta` logic exists in reward and penalty paths.                                                                                         | MERGE              |
| MED      | `src/domain/questRewards.ts:142`, `src/domain/questPenalties.ts:160`                                                                                                                                    | ✅ DONE — Near-duplicate `getBrandReputationKey` logic differs only by parameter naming/type context.                                                                                   | MERGE              |
| MED      | `src/domain/questRewards.ts:151`, `src/domain/questPenalties.ts:169`                                                                                                                                    | ✅ DONE — Near-duplicate `applyBrandTrustDelta` logic exists in both quest outcome modules.                                                                                             | MERGE              |
| LOW      | `src/domain/questRewards.ts:192`, `src/domain/questPenalties.ts:212`                                                                                                                                    | ✅ DONE — Exact duplicate `queueEvent` helper exists in reward and penalty paths.                                                                                                       | MERGE              |
