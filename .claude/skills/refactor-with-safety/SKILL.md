...
description: Trigger when asked to clean up, restructure, or optimize code. Enforces test coverage and quality gates.
---
...
1.  **Preparation**
    ...
    - **Baseline (script form)**: Run `pnpm run test`.
