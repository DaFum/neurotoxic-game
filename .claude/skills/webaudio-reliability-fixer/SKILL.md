...
description: Trigger when audio crackles, fails to start, or desyncs. Handles autoplay policies and context lifecycle.
---
...
1.  **Check Autoplay Policy**
    ...
    - **Relevant files**: `src/utils/audio/AudioManager.ts`, `src/utils/audio/audioEngine.ts`, `src/hooks/rhythmGame/useRhythmGameAudio.ts`.
