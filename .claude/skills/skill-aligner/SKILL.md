...
- A skill mentions "Vite 7" but you upgraded to "Vite 8.0.10"
...
- Commit message should note what drifted and why (e.g., "sync to React 19.2.5 upgrade")
...
**Problem**: Skill references "Vite 7" and old file structure, but we're on Vite 8.0.10 with API changes

**Steps**:

1. Audit: Extract version references → "Vite 7 compatible"
2. Cross-reference: Package.json says `"vite": "8.0.1"`, CLAUDE.md says "Vite 8.0.10 required"
3. Risk assessment:
