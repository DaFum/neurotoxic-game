...
## Agents Usage & Limitations

This document contains guidelines for AI agents and developers.
- **Limitations:** Agents do not replace human review. They must follow the strict rules defined here.
- **When to use:** Use agents to enforce TypeScript strictness, write tests, and assist with complex typing.
