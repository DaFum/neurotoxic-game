...
Guided workflow to eliminate copy-paste duplication in source code. Use after running the jscpd CLI to detect clones.
...
```bash
pnpm exec jscpd --reporters ai <path>
```

See the jscpd CLI documentation for full option reference.
