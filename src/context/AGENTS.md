...
- Action creators sanitize raw payload fields as early as possible. Clamp or normalize direct user/input values such as costs, rewards, deltas, ids, and toast payloads before dispatch when the invariant is local to the payload itself.
