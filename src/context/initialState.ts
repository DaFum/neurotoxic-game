  ...
  members: [
    {
      ...
      relationships: { Marius: 50, Lars: 50 } as Record<string, number>
    },
    {
      ...CHARACTERS.MARIUS,
      mood: 80,
      stamina: 100,
      traits: Object.create(null),
      relationships: { Matze: 50, Lars: 50 } as Record<string, number>
    },
    {
      ...CHARACTERS.LARS,
      mood: 80,
      stamina: 100,
      traits: Object.create(null),
      relationships: { Matze: 50, Marius: 50 } as Record<string, number>
    }
  ],
  harmony: 80,
