export const CHATTER_DB = [
  ...
  { text: 'I’m not “quiet”, I’m conserving rage.', weight: 8, condition: state => state.band.members.some(m => m.mood < 30), speaker: 'Lars' },
  { text: 'If we don’t get food soon, I’m eating a cymbal.', weight: 8, condition: state => state.band.members.some(m => m.mood < 25), speaker: 'Lars' },
  { text: 'I’m allergic to optimism right now.', weight: 8, condition: state => state.band.members.some(m => m.mood < 25), speaker: 'Marius' },
  ...
  { text: 'I’m vibrating with serotonin and tinnitus.', weight: 4, condition: state => state.band.members.some(m => m.mood > 80), speaker: 'Marius' },
  ...
  { text: 'If we keep playing like this, we’ll scare ourselves.', weight: 4, condition: state => state.band.members.some(m => m.mood > 80), speaker: 'Lars' },
  ...
  { text: 'HARDER!', weight: 5, condition: state => state.currentScene === 'GIG' && state.band.members.some(m => m.stamina > 80), speaker: 'Lars' },
  ...
  { text: 'If I miss again, just stare at me dramatically.', weight: 4, condition: state => state.currentScene === 'GIG' && state.band.members.some(m => m.stamina < 35), speaker: 'Marius' },
