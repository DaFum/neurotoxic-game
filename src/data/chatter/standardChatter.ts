...
export const CHATTER_DB = [
  ...
  },
  {
    ...
    weight: 2,
    condition: (state: any) => state.currentScene === GAME_PHASES.POST_GIG,
    speaker: 'Marius'
  },
  {
  ...
  // --- CONDITION: LOW MOOD ---
  {
    ...
    weight: 10,
    condition: (state: any, memo: any) => getMinMood(state, memo) < 30
  },
  {
    text: 'chatter:standard.msg_135',
    weight: 10,
    condition: (state: any, memo: any) => getMinMood(state, memo) < 20
  },
  {
    text: 'chatter:standard.msg_136',
    weight: 8,
    condition: (state: any, memo: any) => getMinMood(state, memo) < 25
  },
  {
  ...
  // --- CONDITION: HIGH MOOD ---
  {
    ...
    weight: 5,
    condition: (state: any, memo: any) => getMaxMood(state, memo) > 80
  },
  {
    text: 'chatter:standard.msg_155',
    weight: 5,
    condition: (state: any, memo: any) => getMaxMood(state, memo) > 90
  },
  {
    text: 'chatter:standard.msg_156',
    weight: 1,
    condition: (state: any, memo: any) => getMaxMood(state, memo) > 95
  },
  {
  ...
  },
  {
    ...
    weight: 5,
    condition: (state: any, memo: any) => getMaxMood(state, memo) > 85
  },
  {
  ...
  // --- CONDITION: MONEY ---
  {
    ...
    weight: 10,
    condition: (state: any) => state.player.money < 100
  },
  {
    text: 'chatter:standard.msg_173',
    weight: 5,
    condition: (state: any) => state.player.money > 2000
  },
  {
  ...
  },
  {
    ...
    weight: 10,
    condition: (state: any) => state.player.money < 120
  },
  {
    text: 'chatter:standard.msg_177',
    weight: 8,
    condition: (state: any) => state.player.money < 150
  },
  {
  ...
  },
  {
    ...
    weight: 4,
    condition: (state: any) => state.player.money > 2200
  },
  {
  ...
  },
  {
    ...
    weight: 4,
    condition: (state: any) => state.player.money > 1800
  },
  ...
  // --- CONDITION: FAME/SOCIAL ---
  {
    ...
    weight: 3,
    condition: (state: any) => state.social?.instagram > 500
  },
  {
    text: 'chatter:standard.msg_188',
    weight: 5,
    condition: (state: any) => state.social?.viral > 0
  },
  {
  ...
  },
  {
    ...
    weight: 3,
    condition: (state: any) => (state.social?.instagram || 0) > 500
  },
  {
    text: 'chatter:standard.msg_192',
    weight: 3,
    condition: (state: any) => (state.social?.instagram || 0) > 800
  },
  {
  ...
  },
  {
    ...
    weight: 3,
    condition: (state: any) => (state.social?.instagram || 0) > 1000
  },
  {
    text: 'chatter:standard.msg_195',
    weight: 5,
    condition: (state: any) => (state.social?.viral || 0) > 0
  },
  {
  ...
  },
  {
    ...
    weight: 3,
    condition: (state: any) => (state.social?.instagram || 0) > 700
  },
  {
  ...
  },
  {
    ...
    weight: 3,
    condition: (state: any) => (state.social?.instagram || 0) > 900,
    speaker: 'Matze'
  },
  {
  ...
  // --- LOCATION SPECIFIC (General) ---
  {
    ...
    weight: 10,
    condition: (state: any) => isPlayerInCity(state, 'stendal')
  },
  {
    text: 'chatter:standard.msg_203',
    weight: 5,
    condition: (state: any) => isPlayerInCity(state, 'berlin')
  },
  {
  ...
  // --- CONDITION: BAND HARMONY ---
  {
    ...
    weight: 8,
    condition: (state: any) => state.band.harmony < 40
  },
  {
    text: 'chatter:standard.msg_231',
    weight: 8,
    condition: (state: any) => state.band.harmony < 35
  },
  {
  ...
  },
  {
    ...
    weight: 10,
    condition: (state: any) => state.band.harmony < 30
  },
  {
  ...
  },
  {
    ...
    weight: 5,
    condition: (state: any) => state.band.harmony > 85
  },
  {
  ...
  },
  {
    ...
    weight: 5,
    condition: (state: any) => state.band.harmony > 90
  },
  {
  ...
  // --- CONDITION: VAN STATE ---
  {
    ...
    weight: 10,
    condition: (state: any) => state.player.van.fuel < 25
  },
  {
    text: 'chatter:standard.msg_245',
    weight: 10,
    condition: (state: any) => state.player.van.fuel < 20
  },
  {
  ...
  },
  {
    ...
    weight: 10,
    condition: (state: any) => state.player.van.fuel < 15,
    speaker: 'Marius'
  },
  {
  ...
  },
  {
    ...
    weight: 10,
    condition: (state: any) => state.player.van.condition < 30
  },
  {
    text: 'chatter:standard.msg_250',
    weight: 10,
    condition: (state: any) => state.player.van.condition < 25
  },
  {
    text: 'chatter:standard.msg_251',
    weight: 8,
    condition: (state: any) => state.player.van.condition < 35,
    speaker: 'Matze'
  },
  {
  ...
  },
  {
    ...
    weight: 10,
    condition: (state: any) => state.player.van.condition < 20
  },
  {
    text: 'chatter:standard.msg_254',
    weight: 4,
    condition: (state: any) => state.player.van.condition > 90
  },
  {
    text: 'chatter:standard.msg_255',
    weight: 4,
    condition: (state: any) => state.player.van.fuel > 85
  },
  {
  ...
  // --- CONDITION: TOUR PROGRESSION ---
  {
    ...
    weight: 8,
    condition: (state: any) => state.player.day <= 2
  },
  {
    text: 'chatter:standard.msg_259',
    weight: 8,
    condition: (state: any) => state.player.day <= 3,
    speaker: 'Lars'
  },
  {
  ...
  },
  {
    ...
    weight: 6,
    condition: (state: any) => state.player.day <= 4
  },
  {
    text: 'chatter:standard.msg_262',
    weight: 5,
    condition: (state: any) => state.player.day >= 10 && state.player.day <= 20
  },
  {
    text: 'chatter:standard.msg_263',
    weight: 5,
    condition: (state: any) => state.player.day >= 12
  },
  {
    text: 'chatter:standard.msg_264',
    weight: 5,
    condition: (state: any) => state.player.day >= 15,
    speaker: 'Lars'
  },
  {
    text: 'chatter:standard.msg_265',
    weight: 8,
    condition: (state: any) => state.player.day >= 25
  },
  {
  ...
  },
  {
    ...
    weight: 8,
    condition: (state: any) => state.player.day >= 28
  },
  {
    text: 'chatter:standard.msg_268',
    weight: 6,
    condition: (state: any) => state.player.totalTravels <= 2
  },
  {
    text: 'chatter:standard.msg_269',
    weight: 4,
    condition: (state: any) => state.player.totalTravels >= 15
  },
  {
    text: 'chatter:standard.msg_270',
    weight: 4,
    condition: (state: any) => state.player.totalTravels >= 20,
    speaker: 'Marius'
  },
  {
    text: 'chatter:standard.msg_271',
    weight: 4,
    condition: (state: any) => state.player.totalTravels >= 18
  },
  ...
  // --- CONDITION: FAME MILESTONES ---
  {
    ...
    weight: 6,
    condition: (state: any) => (state.player.fame || 0) < 50
  },
  {
  ...
  },
  {
    ...
    weight: 6,
    condition: (state: any) => (state.player.fame || 0) < 30
  },
  {
    text: 'chatter:standard.msg_275',
    weight: 5,
    condition: (state: any) => (state.player.fameLevel || 0) >= 2
  },
  {
  ...
  },
  {
    ...
    weight: 4,
    condition: (state: any) => (state.player.fameLevel || 0) >= 3
  },
  {
  ...
  },
  {
    ...
    weight: 3,
    condition: (state: any) => (state.player.fameLevel || 0) >= 4
  },
  {
  ...
  },
  {
    ...
    weight: 2,
    condition: (state: any) => (state.player.fameLevel || 0) >= 5,
    speaker: 'Marius'
  },
  {
  ...
  // --- CONDITION: INVENTORY AWARENESS ---
  {
    ...
    weight: 10,
    condition: (state: any) => state.band.inventory?.strings === false,
    speaker: 'Matze'
  },
  {
    text: 'chatter:standard.msg_285',
    weight: 10,
    condition: (state: any) => state.band.inventory?.cables === false
  },
  {
    text: 'chatter:standard.msg_286',
    weight: 10,
    condition: (state: any) => state.band.inventory?.drum_parts === false
  },
  {
  ...
  },
  {
    ...
    weight: 3,
    condition: (state: any) => state.band.inventory?.golden_pick === true
  },
  {
  ...
  },
  {
    ...
    weight: 6,
    condition: (state: any) => state.band.inventory?.shirts < 10
  },
  {
    text: 'chatter:standard.msg_295',
    weight: 6,
    condition: (state: any) => state.band.inventory?.hoodies <= 0
  },
  ...
  // --- CONDITION: GIG MODIFIERS ---
  {
    ...
    weight: 5,
    condition: (state: any) => state.gigModifiers?.catering === true
  },
  {
  ...
  },
  {
    ...
    weight: 5,
    condition: (state: any) => state.gigModifiers?.promo === true
  },
  {
  ...
  },
  {
    ...
    weight: 5,
    condition: (state: any) => state.gigModifiers?.soundcheck === true
  },
  {
  ...
  },
  {
    ...
    weight: 4,
    condition: (state: any) => state.gigModifiers?.guestlist === true
  },
  {
    text: 'chatter:standard.msg_303',
    weight: 4,
    condition: (state: any) => state.gigModifiers?.merch === true
  },
  {
  ...
  // --- CONDITION: LUCK ---
  {
    ...
    weight: 5,
    condition: (state: any) => (state.band.luck || 0) > 3
  },
  {
  ...
  },
  {
    ...
    weight: 4,
    condition: (state: any) => (state.band.luck || 0) > 4
  },
  {
    text: 'chatter:standard.msg_309',
    weight: 4,
    condition: (state: any) => (state.band.luck || 0) > 5,
    speaker: 'Marius'
  },
  {
    text: 'chatter:standard.msg_310',
    weight: 8,
    condition: (state: any) => (state.band.luck || 0) < -2
  },
  {
  ...
  // --- MINIGAME: TRAVEL ---
  {
    ...
    weight: 5,
    condition: (state: any) => state.currentScene === GAME_PHASES.TRAVEL_MINIGAME,
    speaker: 'Marius'
  },
  {
  ...
  // --- MINIGAME: ROADIE ---
  {
    ...
    weight: 5,
    condition: (state: any) => state.currentScene === GAME_PHASES.PRE_GIG_MINIGAME
  },
  {
