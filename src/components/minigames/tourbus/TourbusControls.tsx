  ...
  return (
    <div className='absolute inset-0 z-(--z-stage-controls) flex justify-between pointer-events-auto'>
      <button
        ...
        className='w-1/2 h-full active:bg-star-white/5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-toxic-green focus-visible:ring-inset flex items-center justify-center sm:hidden text-star-white/30 text-4xl'
        onClick={onMoveLeft}
      >
        {'<'}
      </button>
