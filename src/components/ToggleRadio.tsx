  ...
  return (
    <Tooltip content={label}>
      <button
        type='button'
        onClick={toggle}
        className='bg-[color:var(--color-void-black)] border-2 border-[color:var(--color-toxic-green)] text-[color:var(--color-toxic-green)] w-11 h-11 flex items-center justify-center hover:bg-[color:var(--color-toxic-green)] hover:text-[color:var(--color-void-black)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-toxic-green)] focus-visible:ring-offset-2 focus-visible:ring-offset-void-black touch-manipulation'
        aria-label={label}
