            ...
            >
              ...
              <div className='flex flex-1 flex-col gap-1'>
                ...
                <button
                  ...
                  className='mt-1 min-h-11 self-start border-2 px-2 py-2 disabled:opacity-30 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--section-accent,theme(colors.toxic-green))] focus-visible:ring-offset-void-black'
                  style={{
