            ...
            >
              ...
              {canRefinance && (
                <button
                  ...
                  className='border px-2 py-1 uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--section-accent,theme(colors.toxic-green))] focus-visible:ring-offset-void-black'
                  style={{
                    borderColor:
