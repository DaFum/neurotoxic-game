    ...
    >
      ...
      <div className='relative z-50 w-full max-w-5xl h-[90vh] border-2 border-toxic-green bg-void-black flex flex-col shadow-[0_0_50px_var(--color-toxic-green)]'>
        ...
        <div
          ...
          tabIndex={0}
          className='flex-1 min-h-0 overflow-y-auto p-6 scrollbar-auto scrollbar-thumb-toxic-green scrollbar-track-void-black focus-visible:outline-none touch-pan-y'
        >
          <Suspense
            fallback={
