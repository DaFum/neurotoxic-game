...
import { ProgressBar, Tooltip } from "../shared/index";
		...
		>
			<div className="flex items-center gap-1.5 min-w-0">
				{isWarning && (
					...
					>
						<button
							type="button"
							className="shrink-0 pointer-events-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-toxic-green rounded-full flex items-center justify-center"
						>
							<AlertCircle
								size={12}
								className={
									isStaminaLow ? "text-blood-red" : "text-warning-yellow"
								}
								role="img"
			...
			<div className="flex items-center gap-1.5 shrink-0">
				...
				>
					<button
						type="button"
						className="flex items-center gap-1 pointer-events-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-toxic-green w-full text-left"
					>
						<div className="w-12">
							<ProgressBar
								value={mood}
