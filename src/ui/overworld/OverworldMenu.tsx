...
const MenuHeader = React.memo(
  ({
    ...
    <div className='menu-panel-hdr flex items-center justify-between px-3.5 py-2.5 border-b border-toxic-green/20 bg-toxic-green/5'>
      <div className='menu-panel-title font-display text-[15px] text-toxic-green tracking-[2px] drop-shadow-[0_0_8px_theme(colors.toxic-green)] flex items-center gap-2'>
        {cat ? (
          <>
...
export const OverworldMenu = React.memo(
  ({
    ...
    const cat = activeCat ? categoryMap.get(activeCat) : undefined
