...
export const EventLog = React.memo(({ t, day, locationId }: EventLogProps) => {
  ...
  const [entries, appendEntries] = useReducer(
  ...
  const previousRef = useRef<{ day: number; locationId: string } | null>(null)
  ...
  return (
    <div className='event-log absolute bottom-4 left-4 sm:bottom-8 sm:left-8 z-(--z-stage-overlay) pointer-events-none'>
