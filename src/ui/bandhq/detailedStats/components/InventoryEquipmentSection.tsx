              ...
              canConsume ? (
                <div className='flex items-center justify-end gap-2'>
                  <button
                    ...
                    className='min-h-7 border px-2 text-xs uppercase disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-toxic-green focus-visible:ring-offset-2 focus-visible:ring-offset-void-black'
                    style={{
