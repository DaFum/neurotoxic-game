  ...
  return (
    <div className='absolute top-0 left-0 w-full p-4 flex justify-between items-start pointer-events-none z-40 text-sm font-mono'>
      <div className='flex flex-col gap-2'>
        ...
        <button
          onClick={toggleMute}
          className='pointer-events-auto bg-black/80 border border-[var(--toxic-green)] p-2 text-[var(--toxic-green)] w-fit hover:bg-[var(--toxic-green)] hover:text-black transition-colors'
        >
      ...
      <div className='flex flex-col gap-2 items-end'>
        <div className='bg-black/80 border border-[var(--toxic-green)] p-2 text-[var(--toxic-green)] shadow-[0_0_10px_var(--toxic-green)]'>
          ...
          <div className='mt-1 text-right text-[var(--blood-red)]'>
