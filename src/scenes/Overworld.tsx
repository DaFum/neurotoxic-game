...
export const Overworld = () => {
  ...
  return (
    ...
    >
      ...
      {/* Radio Widget */}
      <div className='fixed top-2 right-2 sm:top-8 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 z-(--z-overlay) pointer-events-auto bg-void-black border-2 border-toxic-green p-2 flex items-center gap-2 shadow-[0_0_10px_theme(colors.toxic-green-20)] scale-100 origin-top-right sm:origin-center'>
