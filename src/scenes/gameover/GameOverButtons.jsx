/*
 * (#1) Actual Updates: Extracted action buttons from GameOver.jsx to a standalone file.
 * (#2) Next Steps: Refactor the main GameOver.jsx file to use these new components.
