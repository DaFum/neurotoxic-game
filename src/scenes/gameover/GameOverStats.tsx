...
export const GameOverStats = ({
  ...
  return (
    <motion.div
      ...
      className='border-2 border-blood-red/60 p-6 w-full max-w-lg mb-8 bg-void-black/80 backdrop-blur-sm relative z-10 shadow-[0_0_30px_theme(colors.blood-red-20)]'
    >
