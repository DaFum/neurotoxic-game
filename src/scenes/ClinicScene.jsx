  ...
  return (
    <div className='w-full h-full bg-void-black relative overflow-hidden flex flex-col items-center justify-center p-8'>
      ...
      <div className='z-10 w-full max-w-4xl bg-void-black border-2 border-toxic-green p-6 shadow-[0_0_20px_var(--color-toxic-green-20)] flex flex-col gap-6'>
          ...
          {band.members.map(member => (
            ...
            >
              ...
              <div className='text-xs font-mono text-ash-gray flex flex-col gap-1'>
                <div>{t('ui:clinic.stamina', { defaultValue: 'Stamina:' })} {member.stamina}%</div>
                <div>{t('ui:clinic.mood', { defaultValue: 'Mood:' })} {member.mood}%</div>
              </div>
        ...
        <footer className='pt-4 border-t border-toxic-green/50 flex justify-end'>
