  ...
  ({ t, onAdvance }) => {
    return (
      <div className='absolute inset-0 z-(--z-overlay) flex flex-col items-center justify-center overflow-y-auto bg-void-black/60 backdrop-blur-sm transition-all duration-1000 px-4'>
        <h3 className='text-success-green text-3xl md:text-4xl font-bold tracking-[0.3em] mb-2 drop-shadow-[0_0_15px_theme(colors.success-green)] text-center max-w-full break-words'>
