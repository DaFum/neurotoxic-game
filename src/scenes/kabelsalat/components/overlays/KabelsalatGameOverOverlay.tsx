  ...
  React.memo(({ t, onAdvance }) => {
    return (
      <div className='absolute inset-0 z-(--z-overlay) flex flex-col items-center justify-center overflow-y-auto bg-void-black/90 backdrop-blur-sm px-4'>
        <h3 className='text-error-red text-3xl md:text-5xl font-bold tracking-[0.3em] mb-4 drop-shadow-[0_0_15px_theme(colors.error-red)] text-center max-w-full break-words'>
