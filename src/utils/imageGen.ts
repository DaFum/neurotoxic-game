...
export const IMG_PROMPTS = {
  ...
  ITEM_MERCH_NEURO_CUTTING_BOARD: 'pixel art green toxic glowing cutting board breakfast icon',
  ITEM_MERCH_NEURO_LUNCHBOX: 'pixel art green toxic glowing metal lunchbox icon',
