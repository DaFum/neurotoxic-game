...
- **React 18.2.x**: Core necromancer animating the UI shell.
...
- **Tailwind CSS v4.0.x**: Utility riff machine for brutalist layout control.
- **Vite 5.x**: Ultrafast dev and build pipeline for zero‑patience iteration.
